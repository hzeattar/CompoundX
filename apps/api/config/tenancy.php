...
return [
    ...
    'central_domains' => array_values(array_filter(array_map(
        ...
        explode(',', env('TENANCY_CENTRAL_DOMAINS', 'localhost,127.0.0.1,compoundx.test'))
    ))),
    ...
    'database' => [
         ...
         */
        'template_tenant_connection' => ($templateTenantConnection = env('TENANCY_TEMPLATE_CONNECTION')) !== null && $templateTenantConnection !== ''
            ? $templateTenantConnection
            : (env('DB_CONNECTION') === 'central' ? 'tenant' : null),
